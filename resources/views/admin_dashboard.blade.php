            ...
            <div class="displayinfo" id="profile">
                ...
                <div class="reservations">
                    <div class="reservations_columns">
                        <p class="input">NOMBRE:<br> <?php echo $admindata[0]->nombre;?></p>
                    </div>
                    <div class="reservations_columns">
                        <p class="input">APELLIDOS:<br> <?php echo $admindata[0]->apellido1;?> <?php echo $admindata[0]->apellido2;?></p>
                    </div>
                    <div class="reservations_columns">
                        <p class="input">EMAIL:<br> <?php echo $admindata[0]->email_admin;?></p>
                    </div>
                </div>
            </div>
